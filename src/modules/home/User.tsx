...
class User extends Component {
    ...
    render() {
        if (LoginStore.getUserData) {
            return (
                <div css={WrapUser} className="user">
                    <div className="user-hover">
                        {LoginStore.getUserData.avatarUrl ?
                            ...
                            <div className="d-flex align-items-center">
                                <div className="img-user " style={{lineHeight: `60px`, width: `36px`}}>
                                    <img src="/assets/images/home/iconAvatar.svg" alt=""/>
                                </div>
                                <div className="information-user">
                                    <p className="text-white">Xin chào</p>
                                    <span>{this.converName(LoginStore.getUserData.name)}</span>
                        ...
                        <div className="list-manager-information">
                            <div className="manager-information">
                                ...
                                <Link to={`/customer/favorite?page=0`} className="css_information-user text-center">
                                    <div className="img">
                                ...
                                <Link to="/customer/voucher?type=available&provider=chozoi&page=0"
                                      className="css_information-user text-center">
                                    <div className="img">
